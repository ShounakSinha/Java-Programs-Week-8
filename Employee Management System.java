...
class Main {
    public static void main(String[] args)throws IOException {
        ...
        manager.setName(read.readLine());
        System.out.print("Enter ID: ");
        manager.setId(read.readLine());
        System.out.print("Enter Salary: ");
        manager.setSalary(Integer.parseInt(read.readLine()));
        System.out.print("Enter Department: ");
        manager.setDepartment(read.readLine());
        System.out.println("\nEnter details for Developer:");
        Developer developer = new Developer();
        System.out.print("Enter Name: ");
        developer.setName(read.readLine());
        System.out.print("Enter ID: ");
        developer.setId(read.readLine());
        System.out.print("Enter Salary: ");
        developer.setSalary(Integer.parseInt(read.readLine()));
        System.out.print("Enter Programming Language: ");
        developer.setProgrammingLanguage(read.readLine());
